...
export default function ContactSection() {
  return (
    <section className="py-20 lg:py-28 bg-transparent relative overflow-hidden" id="contact">
      ...
      <div className="max-w-4xl mx-auto px-6 relative z-10">
        <motion.div 
          ...
          className="bg-white/95 backdrop-blur-xl p-6 md:p-10 rounded-[3rem] shadow-2xl"
        >
          ...
          <form className="grid md:grid-cols-2 gap-6">
            ...
            <div className="md:col-span-2 pt-6">
              <Link href="/contact" className="block w-full py-4 rounded-full bg-primary text-on-primary font-bold text-lg shadow-xl shadow-primary/30 hover:scale-[1.01] transition-transform text-center">
                Gửi yêu cầu ngay
              </Link>
            </div>
          </form>
